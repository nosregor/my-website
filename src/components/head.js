...
const Head = ({ metaData }) => (
  <Helmet>
    ...
    <meta property="og:metaData.title" content={metaData.title} />
    <meta property="og:metaData.description" content={metaData.description} />
    ...
    <meta itemProp="metaData.description" content={metaData.description} />
    <meta itemProp="image" content={config.siteImage} />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:url" content={metaData.siteUrl} />
    <meta name="twitter:site" content={config.twitterHandle} />
    <meta name="twitter:creator" content={config.twitterHandle} />
    <meta name="twitter:metaData.title" content={metaData.title} />
    <meta name="twitter:metaData.description" content={metaData.description} />
