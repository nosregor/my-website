...
import { theme, Section, H3, A } from '../style';
    ...
    <TabsContainer>
      ...
      <TabContentContainer>
        <TabContent data-tab="1">
          <p>
            Lorem ipsum dolor amet umami kogi you probably haven&apos;t heard of them activated
            charcoal hexagon literally. Vice art party XOXO retro blue bottle. Squid tousled
            skateboard man bun pabst unicorn sriracha poutine echo park crucifix plaid health goth
            four dollar toast. XOXO gochujang PBR&B kombucha brooklyn street art lyft swag.
          </p>
        </TabContent>
        ...
        <TabContent data-tab="3">
          <p>
            Gluten-free you probably havent heard of them jianbing pitchfork pabst. Kombucha occupy
            ...
            heirloom, shoreditch kinfolk swag cold-pressed 90s chicharrones.
          </p>
        </TabContent>
      </TabContentContainer>
    </TabsContainer>
